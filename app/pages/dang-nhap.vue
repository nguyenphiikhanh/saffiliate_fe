<template>
  <div
    class="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 relative overflow-hidden login-page-wrapper"
  >
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <!-- Login Card -->
      <div class="bg-white dark:bg-slate-900 shadow-xl rounded-2xl p-6 sm:p-8 border border-slate-100 dark:border-slate-800">
        <a-alert
          v-if="errorMessage"
          type="error"
        ...
        >
          ...
          <span v-else class="animate-spin rounded-full h-5 w-5 border-b-2 border-slate-700 dark:border-slate-200"></span>
...
onMounted(async () => {
  if (typeof window !== "undefined" && window.navigator) {
    ...
    // Initialize Theme for layout: false page
...
:deep(.inapp-modal .ant-modal-title),
:deep(.inapp-modal .ant-modal-close-x) {
