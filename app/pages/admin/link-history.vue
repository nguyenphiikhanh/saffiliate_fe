  ...
  <div class="flex flex-col gap-6 pb-12">
      ...
      >
        ...
        >
          ...
          <CloseOutlined
            ...
            class="ml-1 cursor-pointer hover:text-rose-500"
          ...
          <template #bodyCell="{ column, record }">
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col min-w-0">
                  ...
                  <span
                    ...
                    :title="record.user?.email || record.user_id"
            ...
            <template v-else-if="column.key === 'platform'">
              <span
                ...
                :class="getPlatformStyle(record.type)"
              >
                {{
        ...
        >
          ...
          >
            ...
            <a-button
              ...
              type="text"
              class="font-semibold text-xs text-slate-400 hover:text-white flex items-center gap-1"
            >
    ...
    >
      ...
      <div class="relative w-full max-w-xl overflow-hidden min-h-[150px] max-h-[400px] overflow-y-auto">
        ...
        <div v-if="userPagination.totalPages > 1" class="flex justify-between items-center w-full mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
...
const columns = [
  ...
  { title: 'Tạo Bởi', key: 'user', width: '25%' },
  { title: 'Nền Tảng', key: 'platform', width: '15%' },
  { title: 'Sản Phẩm', key: 'product', width: '40%' },
  { title: 'Chi Tiết', key: 'details', align: 'center', width: '5%' }
];
