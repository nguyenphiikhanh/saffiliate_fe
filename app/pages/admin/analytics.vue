      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Hoa hồng sàn</div>
              <div class="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{{ formatMoney(commissionAnalytic.total_commission) }}</div>
            </div>
        ...
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Hoa hồng người dùng</div>
              <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ formatMoney(commissionAnalytic.total_user_commission) }}</div>
            </div>
        ...
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Phí dịch vụ + Thuế</div>
              <div class="text-2xl font-bold text-rose-600 dark:text-rose-400">{{ formatMoney(commissionAnalytic.total_fee) }}</div>
            </div>
        ...
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Lợi nhuận (Ước tính)</div>
              <div class="text-2xl font-bold text-amber-600 dark:text-amber-400">{{ formatMoney(commissionAnalytic.total_profit) }}</div>
            </div>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Tổng người dùng</div>
              <div class="text-2xl font-bold text-slate-800 dark:text-slate-100">{{ userAnalytic.total_users }}</div>
            </div>
        ...
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Người dùng mới</div>
              <div class="text-2xl font-bold text-slate-800 dark:text-slate-100">{{ userAnalytic.new_users }}</div>
            </div>
        ...
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Đã có đơn hàng</div>
              <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ userAnalytic.users_with_orders }}</div>
            </div>
        ...
        <a-card :bordered="false" class="admin-stat-card group hover:-translate-y-1 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
          ...
          <div v-else class="flex justify-between items-center relative z-10">
            <div>
              <div class="text-slate-500 dark:text-slate-400 text-sm font-medium mb-1">Đã tạo link</div>
              <div class="text-2xl font-bold text-pink-600 dark:text-pink-400">{{ userAnalytic.users_generate_link }}</div>
            </div>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <a-card :bordered="false" class="admin-card border-t-4 border-emerald-500 hover:shadow-xl transition-shadow duration-300">
          <template #title>
            <span class="font-bold text-emerald-700 dark:text-emerald-400">Đơn hàng ({{ orderAnalytic.total_orders }})</span>
          </template>
        ...
        <a-card :bordered="false" class="admin-card border-t-4 border-amber-500 hover:shadow-xl transition-shadow duration-300">
          <template #title>
            <span class="font-bold text-amber-700 dark:text-amber-400">Dòng tiền từ người dùng</span>
          </template>
        ...
        <a-card :bordered="false" class="admin-card lg:col-span-2 border-t-4 border-blue-500 hover:shadow-xl transition-shadow duration-300">
          <template #title>
            <span class="font-bold text-blue-700 dark:text-blue-400">Hiệu suất tiếp thị</span>
          </template>
